    ...
    return SafeArea(
        child: Scaffold(
            ...
            appBar: AppBar(
              ...
              backgroundColor: ColorConstant.white_A700,
              title: Padding(
                  padding: EdgeInsets.only(left: getHorizontalSize(22)),
                  child: Text(controller.homeModelObj.value.txtHome.value,
                                  ...
                                  children: [
                                    ...
                                    Container(
                                        ...
                                        child: Obx(() => ListView.builder(
                                            ...
                                            itemBuilder: (context, index) {
                                              Rx<HomeItemModel> model =
                                                  controller.homeModelObj.value
                                                      .homeItemList[index].obs;
                                    ...
                                    Padding(
                                        ...
                                        child: Obx(() => ListView.builder(
                                            ...
                                            shrinkWrap: true,
                                            itemCount: controller.homeModelObj
                                                .value.home1ItemList.length,
                                            itemBuilder: (context, index) {
                                              Rx<Home1ItemModel> model =
                                                  controller.homeModelObj.value
                                                      .home1ItemList[index].obs;
